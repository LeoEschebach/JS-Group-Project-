...
parentUL.addEventListener('click', removeItem);     // create 'removeItem() function' for Part 2 (line )
...
function addItem(e) {
    ...
    // Get input .value
    let newInput = document.getElementById('new-item').value;    // newItem
...
//    console.log("hi");
 //   console.log(newLi);     // log in variable  // parent is 'newLi' let (variable)
    ...
    newLi.appendChild(document.createTextNode(newInput)).innerHTML;
    ...
    // Append button to variable 'li'
    newLi.appendChild(del);

    // Append new variable 'li' to list
